import type { Market, MarketCardProps } from '../types'
...
function TeamDisplay({ team }: { team: { name: string, crest: string } }) {
  return (
...
function MarketCardContent({ market }: { market: Market }) {
    ...
    return (
      <div className="bg-white rounded-[16px] shadow-md p-6 border border-red-200 flex flex-col items-center justify-center text-center min-h-[400px]">
        ...
        <p className="text-sm text-slate-500">
          Could not load details for Match ID:
        ...
        <InfoRow
          ...
          value={(
            <>
              ...
              {' '}
              <span className="font-normal text-slate-400">PAS</span>
            </>
          )}
          icon="mdi--login"
        />
